...
定义, 全局收敛, 局部收敛, [Lipschitz 收敛](/source/wiki/course/calculus/array-limit.md#压缩映射原理)
...
是一种特殊形式的不动点迭代, 希望提高迭代的[收敛阶](/source/wiki/course/optim/unconstrained.md#收敛阶), 构造不动点迭代使得
