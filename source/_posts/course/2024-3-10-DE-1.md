...
![20240310164541](https://cdn.duanyll.com/img/20240310164541.png)
...
The order of the truncation error of FDE: $o(h^3)\implies$ Second ordered method.

$$
\begin{aligned}
    y_{j+1}-y_j+\tau&=\frac{h}{2}(3f(t_j)-f(t_j-h))\\
    f(t_j)h+\frac{f'(t_j)}{2}h^2+\frac{f''(t_j)}{6}h^3+\cdots+\tau&=\frac{h}{2}(3f(t_j)-f(t_j)+f'(t_j)h-\frac{f''(t_j)}{2}h^2+\cdots)\\
    &=f(t_j)h+\frac{f'(t_j)}{2}h^2-\frac{f''(t_j)}{4}h^3+\cdots\\
    \tau&=-\frac{f''(t_j)}{3}h^3\\
    &\sim o(h^3)
\end{aligned}
$$
...
![20240310213133](https://cdn.duanyll.com/img/20240310213133.png)
...
![20240317174502](https://cdn.duanyll.com/img/20240317174502.png)

![20240317174559](https://cdn.duanyll.com/img/20240317174559.png)
...
![20240317174632](https://cdn.duanyll.com/img/20240317174632.png)
...
![20240318000903](https://cdn.duanyll.com/img/20240318000903.png)
...
![20240318111556](https://cdn.duanyll.com/img/20240318111556.png)
...
![20240318111800](https://cdn.duanyll.com/img/20240318111800.png)