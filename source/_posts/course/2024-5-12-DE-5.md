...
*From some numerical experiments* we can find that the magnitude of the amplification factor $\kappa$ is less than 1 for all positive $k,h,r$. The method is always stable.
